...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Medication>(entity =>
        {
            ...
            entity.HasIndex(e => e.MedicineName, "UQ__MEDICATI__722522D70432D99D").IsUnique();
        ...
        modelBuilder.Entity<Patient>(entity =>
        {
            ...
            entity.HasIndex(e => e.Phone, "UQ__PATIENTS__B43B145FDD5E9F4D").IsUnique();
        ...
        modelBuilder.Entity<Specialty>(entity =>
        {
            ...
            entity.HasIndex(e => e.SpecialtyName, "UQ__SPECIALT__9BDDB60A0CF3AE19").IsUnique();
        ...
        modelBuilder.Entity<User>(entity =>
        {
            ...
            entity.HasIndex(e => e.Phone, "UQ__USERS__B43B145F456A7748").IsUnique();
